    ...
    inputs: [
      {
        components: [
          ...
          { internalType: 'bool', name: 'hasDynamicSignature', type: 'bool' },
    ...
    inputs: [
      ...
      },
      {
        components: [
          ...
          { internalType: 'uint128[]', name: 'fillAmounts', type: 'uint128[]' },
          {
            internalType: 'uint128[]',
            name: 'executeAmounts',
            type: 'uint128[]',
  ...
  },
  {
    inputs: [
      ...
      },
      {
        ...
        internalType: 'struct MemswapERC20.AuthorizationWithSignature[]',
        name: 'auths',
        type: 'tuple[]',
      },
      {
